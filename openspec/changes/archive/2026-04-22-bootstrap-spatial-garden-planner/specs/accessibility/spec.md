...
- **THEN** the UI MUST render a green-tone accent _and_ a "✓" icon _and_ the caption text
- **AND** the audio TTS MUST play _and_ a single-short haptic MUST fire
...
- **THEN** the red-tone accent _and_ the "✕" icon _and_ the persistent caption _and_ the long haptic MUST still fire
