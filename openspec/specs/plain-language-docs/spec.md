# plain-language-docs Specification

## Purpose

Ensures all user-facing documentation uses plain language accessible to non-technical growers, with no unexplained developer jargon and honest caveats about current limitations.
