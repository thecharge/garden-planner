# button-label-required Specification

## Purpose

Enforces that every `GardenButton` rendered in the app carries a required `accessibilityLabel`, making the TypeScript type system the first line of defence for screen-reader accessibility.
