# rotation-advisor Specification
...
- **THEN** the recommendation MUST be demoted _and_ MUST surface a `summary.warning` entry in the response explaining the negative pairing
